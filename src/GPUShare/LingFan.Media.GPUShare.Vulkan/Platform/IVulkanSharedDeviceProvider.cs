...
/// 规避 Adreno 跨实例 OPAQUE_FD 导入缺陷（vkAllocateMemory 报 INITIALIZATION_FAILED）。
/// </summary>
/// <remarks>
/// <para><b>放置说明</b>：本接口是 Vulkan 渲染后端的宿主协作细节，<b>不属于契约层</b>
/// （Abstractions 只放媒体抽象，平台桥接细节归属渲染后端）。</para>
...
/// <summary>共享 Vulkan device 的原生句柄组。</summary>
