...
/// </summary>
/// <remarks>
/// <para>FFmpeg 未随核心库暴露 <c>libavcodec/jni.h</c> / <c>mediacodec.h</c> 的包装
/// （Android 专属头文件）→ 此处直接 <c>LibraryImport("avcodec")</c> 经加载器已解析句柄调用。</para>
...
internal static partial class MediaCodecInterop
{
    ...
    [LibraryImport("avcodec", EntryPoint = "av_jni_set_java_vm")]
    ...
    /// <returns>0 成功；负值为 AVERROR。</returns>
    [LibraryImport("avcodec", EntryPoint = "av_mediacodec_release_buffer")]
