...
public static class VulkanExtensions
{
    ...
    public static MediaBuilder AddVulkanRenderer(this MediaBuilder builder)
    {
        ...
        builder.Services.AddSingleton<IVideoRendererFactory, VulkanRendererFactory>();
